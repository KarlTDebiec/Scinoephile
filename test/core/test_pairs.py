...
from ..data.kob import kob_eng, kob_yue_hans  # noqa: F401
from ..data.mnt import mnt_eng, mnt_zho_hant  # noqa: F401
from ..data.pdp import pdp_eng, pdp_yue_hant  # noqa: F401
from ..data.t import t_eng, t_zho_hans  # noqa: F401
