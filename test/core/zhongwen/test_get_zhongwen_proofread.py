...
def test_get_zhongwen_text_flattened(text: str, expected: str):
    """Test _get_zhongwen_text_flattened.

    Arguments:
        text: Text to flatten
        expected: Expected flattened text
    """
    assert _get_zhongwen_text_flattened(text) == expected
