...
@pytest.mark.parametrize(
    "pinyin_infile",
    [f"{m.input}/cmn-pinyin.srt"
     for m in [saving_mr_wu]] +
    [f"{m.input}/yue-pinyin.srt"
     for m in [king_of_beggars]])
...
@pytest.mark.parametrize(
    ...
    [(f"{m.output}/cmn-hans_en.srt",
      f"{m.input}/en.srt",
      f"{m.input}/cmn-Hans.srt")
     for m in [mcdull_prince_de_la_bun, saving_mr_wu, trivisa]] +
    [(f"{m.output}/yue-hans_en.srt",
      f"{m.input}/en.srt",
      f"{m.input}/yue-Hans.srt")
     for m in [king_of_beggars]])
...
@pytest.mark.parametrize(
    ...
    [(f"{m.input}/cmn-hans.srt",
      "mandarin",
      f"{m.output}/cmn-pinyin.srt")
     for m in [saving_mr_wu]] +
    [(f"{m.input}/yue-hans.srt",
      "cantonese",
      f"{m.output}/yue-pinyin.srt")
     for m in [king_of_beggars]])
