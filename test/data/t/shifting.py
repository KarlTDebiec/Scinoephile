...
shift_test_cases_block_3 = [
    ...
    ShiftTestCase(
        ...
        zhongwen_2="双方开枪过百发",
        yuewen_2="双方开枪过白房",
        yuewen_1_shifted="同喺附近秘密执勤嘅飞虎队员发生枪战双方",
        yuewen_2_shifted="开枪过白房",
        difficulty=1,
    ),
    ShiftTestCase(
        zhongwen_1="双方开枪过百发",
        ...
        yuewen_1_shifted="开枪过白房事件中",
        yuewen_2_shifted="两名逃人及三名军人警察获杀",
        difficulty=1,
    ),
    ShiftTestCase(
        zhongwen_1="事件中，两名途人及三名军装警员受伤",
        yuewen_1="两名逃人及三名军人警察获杀",
        zhongwen_2="五间金行合共损失大约一千万",
        yuewen_2="现间有狂黑洞损失大约三次万",
        yuewen_1_shifted="两名逃人及三名军人警察获杀现间有狂黑洞",
        yuewen_2_shifted="损失大约三次万",
        difficulty=1,
    ),
    ShiftTestCase(
    ...
    ShiftTestCase(
        ...
        zhongwen_2="都说放多些报纸！",
        yuewen_2="都话贱到啲报纸㗎喇",
        yuewen_1_shifted="但系大剂啦都话",
        yuewen_2_shifted="贱到啲报纸㗎喇",
        difficulty=1,
    ),
    ShiftTestCase(
        zhongwen_1="但大事不妙了！",
    ...
    ShiftTestCase(
        ...
        yuewen_1="都话",
        zhongwen_2="你看！到处都是血！",
        yuewen_2="贱到啲报纸㗎喇睇吓睇吓",
        yuewen_1_shifted="都话贱到啲报纸㗎喇",
        yuewen_2_shifted="睇吓睇吓",
        difficulty=1,
    ),
    ShiftTestCase(
        zhongwen_1="你看！到处都是血！",
