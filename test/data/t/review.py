...
review_test_case_block_3 = ReviewTestCase.get_test_case_cls(17)(
    ...
    yuewen_revised_8="",
    note_8="",
    yuewen_revised_9="五间金行合共损失大约一千万",
    note_9="The missing context regarding the '五间金行' was added to "
    "subtitle 9 for completeness.",
    yuewen_revised_10="",
    note_10="",
    yuewen_revised_11="",
    note_11="",
    ...
    yuewen_revised_15="",
    note_15="",
    yuewen_revised_16="睇吓！周围都系血！",
    note_16="Repeated word '睇吓' was reduced for a more natural flow.",
    yuewen_revised_17="",
    note_17="",
