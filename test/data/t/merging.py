...
merge_test_cases_block_2 = [
    MergeTestCase(
        ...
        yuewen_merged="嘅 arrangements for Hong Kong contained in",
        difficulty=3,
        verified=True,
    ),
    MergeTestCase(
        ...
        yuewen_merged="the agreement 而 not measures of expediency",
        difficulty=3,
        verified=True,
    ),
    MergeTestCase(
        ...
        yuewen_merged="嘅好 long term policies",
        difficulty=3,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_3 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["同喺附近秘密执勤嘅飞虎队员发生枪战", "双方"],
        yuewen_merged="同喺附近秘密执勤嘅飞虎队员发生枪战，双方",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="双方开枪过百发",
        yuewen_to_merge=["开枪过白房", "事件中"],
        yuewen_merged="开枪过白房，事件中",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="事件中，两名途人及三名军装警员受伤",
        yuewen_to_merge=["两名逃人及三名军人警察获杀", "现间有狂", "黑洞"],
        yuewen_merged="两名逃人及三名军人警察获杀，现间有狂，黑洞",
        difficulty=2,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        ...
        yuewen_merged="系「头号通缉犯」叶国宽",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="一夫当关，万夫莫敌！",
        yuewen_to_merge=["一孤当关万夫莫敌", "真系威吓"],
        yuewen_merged="一孤当关，万夫莫敌！真系威吓",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="真是威风！欢哥！",
    ...
    MergeTestCase(
        zhongwen="都说放多些报纸！",
        yuewen_to_merge=["都话", "贱到啲报纸㗎喇"],
        yuewen_merged="都话，贱到啲报纸㗎喇！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="你看！到处都是血！",
...
merge_test_cases_block_8 = []  # merge_test_cases_block_9
