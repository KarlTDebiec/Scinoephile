...
test_cases = [
    ...
    EnglishProofreadingTestCase.get_test_case_cls(8, EnglishProofreadingPrompt)(
        ...
        note_6="Corrected 'interests' to 'interest' for subject-verb "
        "agreement with the singular 'It is the common interest'.",
        difficulty=1,
        verified=True,
    ),
    ...
    EnglishProofreadingTestCase.get_test_case_cls(10, EnglishProofreadingPrompt)(
        ...
        subtitle_9="But after 48 hours, they have to release me.",
        subtitle_10="By that time, however, you son will be…",
        revised_10="By that time, however, your son will be…",
        note_10="Corrected 'you son' to 'your son'.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(1, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(6, EnglishProofreadingPrompt)(
        ...
        subtitle_4="I might as well cut if off, OK?",
        subtitle_5="Please don't!",
        subtitle_6="I'm sorry! I'm sorry!",
        revised_4="I might as well cut it off, OK?",
        note_4="Corrected 'if' to 'it' to match the intended meaning: 'cut it off'.",
        difficulty=1,
        prompt=True,
        verified=True,
    ),
    ...
    EnglishProofreadingTestCase.get_test_case_cls(3, EnglishProofreadingPrompt)(
        ...
        note_3="Corrected 'Yea' to 'Yeah' for standard usage in this context.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(1, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(11, EnglishProofreadingPrompt)(
        ...
        subtitle_4="This is Chief Chen from Industry and Commerce.",
        subtitle_5="We're buddies.",
        subtitle_6="Nice to meet you, Chief Chen.",
        subtitle_7="Nice to meet you.",
        subtitle_8="Let's have a drink.",
        subtitle_9="Let's drink together.",
        subtitle_10="Have a seat.",
    ...
    EnglishProofreadingTestCase.get_test_case_cls(38, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(5, EnglishProofreadingPrompt)(
        ...
        revised_4="Plus 80 VCD players. RMB¥4K apiece.",
        note_4="Changed 'a piece' to 'apiece' for correct usage.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(5, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(22, EnglishProofreadingPrompt)(
        ...
        subtitle_13="Sure.",
        subtitle_14="Da-bao Electronics",
        subtitle_15="She is greedy.",
        subtitle_16="That's business.",
        subtitle_17="Don't pull a long face all day long.",
        subtitle_18="Boss Zhang, Boss Zhang.",
        subtitle_19="No worries. They will take care of it.",
        subtitle_20="- Quick\n- What's wrong?",
        subtitle_21="Boss Zhang.",
        subtitle_22="What's wrong?",
        revised_2="Will notify you once the goods are on board.",
        note_2="Corrected 'onboard' to 'on board' for standard usage in this context.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(3, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(48, EnglishProofreadingPrompt)(
        ...
        revised_19="Bro Foon, are you making a comeback?",
        note_19="Corrected 'Bro foon' to 'Bro Foon' to capitalize the name properly.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(2, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(8, EnglishProofreadingPrompt)(
        ...
        note_1="Added 'to' at the end for correct grammar: 'listening to'.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(5, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(25, EnglishProofreadingPrompt)(
        ...
        subtitle_22="Braised pork with preserved vegetables.",
        subtitle_23="It's not refined enough for me.",
        subtitle_24="Let's order delicacies.",
        subtitle_25="Waiter!",
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(16, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(16, EnglishProofreadingPrompt)(
        ...
        subtitle_10="Whoever knows their\nwhereabouts will get the money.",
        subtitle_11="So brazenly? The cops will tap the phone.",
        subtitle_12="Those assholes will prevent the 3 Kings\nfrom meeting up.",
        subtitle_13="Not necessarily.",
        subtitle_14="The cops want them too.",
        subtitle_15="They will send loads of people after us.",
    ...
    EnglishProofreadingTestCase.get_test_case_cls(35, EnglishProofreadingPrompt)(
        ...
        note_4="Added 's' to 'AK-47' to indicate plural, as 'we' implies "
    ...
    EnglishProofreadingTestCase.get_test_case_cls(17, EnglishProofreadingPrompt)(
        ...
        subtitle_4="Look, he has set up a special phone line.",
        subtitle_5="Info for money.",
        subtitle_6="How generous!",
        subtitle_7="Both of them are very dangerous.",
        subtitle_8="Which kingpin is not dangerous?",
        subtitle_9="They are being so brazenly?",
        subtitle_10="The Handover is imminent.",
        subtitle_11="Because the Handover is imminent,\nyou have to do big!",
        subtitle_12="After the Handover,\nit will be slim pickings, Idiot.",
        subtitle_13="Listen.",
        subtitle_14="Sniff out their whereabouts.",
        subtitle_15="The restoration of this\nAssociation depends on you!",
        subtitle_16="Keep me posted, kiddo.",
        subtitle_17="Keep me posted!",
        revised_2="Have you sniffed out that Cheuk\nis looking for Yip and Kwai?",
        note_2="Added 'out' to complete the phrasal verb 'sniffed out'.",
        revised_9="They are being so brazen?",
        note_9="Removed 'ly' from 'brazenly' to correct the phrase to 'so brazen'.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(5, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(13, EnglishProofreadingPrompt)(
        ...
        subtitle_6="A pet it bourgeois!",
        subtitle_7="A greedy, smuggling, tax-evading pet it bourgeois!",
        ...
        revised_6="A petit bourgeois!",
        note_6="Corrected 'pet it bourgeois' to 'petit bourgeois'.",
        revised_7="A greedy, smuggling, tax-evading petit bourgeois!",
        note_7="Corrected 'pet it bourgeois' to 'petit bourgeois'.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(3, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(12, EnglishProofreadingPrompt)(
        ...
        revised_11="Bro Foon, Cheuk has gone mad!",
        note_11="Capitalized 'Foon' to match the proper noun format for a name.",
        difficulty=1,
        verified=True,
    ),
    ...
    EnglishProofreadingTestCase.get_test_case_cls(14, EnglishProofreadingPrompt)(
        ...
        subtitle_14="Win & Place.",
        revised_9="A single winning ticket will make\nyou richer than any king.",
        note_9="Corrected 'kings' to 'king' for correct idiomatic usage: "
    ...
    EnglishProofreadingTestCase.get_test_case_cls(11, EnglishProofreadingPrompt)(
        ...
        subtitle_11="Sure.",
        revised_5="Yes, Bro Foon.",
        note_5="Corrected 'Bro foon.' to 'Bro Foon.' to capitalize the name "
        "as appropriate.",
        revised_7="Bro Foon.",
        note_7="Corrected 'Bro foon.' to 'Bro Foon.' to capitalize the name "
        "as appropriate.",
        difficulty=1,
        verified=True,
    ),
    ...
    EnglishProofreadingTestCase.get_test_case_cls(15, EnglishProofreadingPrompt)(
        ...
        note_4="Changed 'How's' to 'How was' for correct grammar in this context.",
        difficulty=1,
        verified=True,
    ),
    EnglishProofreadingTestCase.get_test_case_cls(3, EnglishProofreadingPrompt)(
    ...
    EnglishProofreadingTestCase.get_test_case_cls(7, EnglishProofreadingPrompt)(
        ...
        subtitle_5="Is that very hard for you?",
        subtitle_6="No, we always follow you, Big Bro.",
    ...
    EnglishProofreadingTestCase.get_test_case_cls(3, EnglishProofreadingPrompt)(
        ...
        note_2="Corrected 'interests' to 'interest' for correct usage in this context.",
        difficulty=1,
        verified=True,
    ),
]  # test_cases
