...
if __name__ == "__main__":
    ...
    cmn_hant_hk_flatten_simplify = get_hanzi_flattened(cmn_hant_hk_simplify)
    cmn_hant_hk_flatten_simplify.save(
        get_output_path("mnt/output/cmn-Hant-HK_flatten_simplify.srt")
    )
