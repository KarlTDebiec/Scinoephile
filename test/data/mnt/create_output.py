...
# from test.data.mnt import mnt_english_proofreading_test_cases as test_cases
#
...
# pprint(test_cases_2[0:10])
# from test.data.mnt.core.english import get_proofreading_test_cases
#
# test_cases_2 = get_proofreading_test_cases()
# pprint(test_cases_2[0:10])

# Load Zhongwen proofreading test cases and migrate to v2, then write to JSON
from test.data.mnt import mnt_zhongwen_proofreading_test_cases as test_cases
...
pprint(test_cases_2[0:10])
# from test.data.mnt.core.zhongwen import get_proofreading_test_cases
