...
def mnt_zho_hans_eng() -> Series:
    """MNT Bilingual ???? and English series."""
...
def get_mnt_zho_hans_proofreading_test_cases(
    ...
    **kwargs: Any,
    ...
    """Get MNT ?? proofreading test cases.
