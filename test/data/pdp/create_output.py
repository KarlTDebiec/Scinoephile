...
if __name__ == "__main__":
    ...
    yue_hant_clean = get_zhongwen_cleaned(yue_hant)
    yue_hant_clean.save(output_dir / "yue-Hant_clean.srt")
    yue_hant_flatten = get_zhongwen_flattened(yue_hant)
    ...
    yue_hant_clean_flatten_simplify = get_zhongwen_converted(
        get_zhongwen_flattened(yue_hant_clean),
        OpenCCConfig.hk2s,
    )
