...
distribute_test_cases_block_0 = [
    DistributeTestCase(
        ...
        yuewen_1_start="再右转屈返出去窝大路道",
        zhongwen_2="飞呀，飞⋯",
        yuewen_2_end="飞下",
        yuewen_to_distribute="向女人街方向飞下下",
        yuewen_1_to_append="向女人街方向",
        yuewen_2_to_prepend="飞下下",
        difficulty=1,
    ),
    DistributeTestCase(
        zhongwen_1="再右拐窝打老道向女人街方向飞⋯",
        yuewen_1_start="再右转屈返出去窝大路道向女人街方向",
        zhongwen_2="飞呀，飞⋯",
        yuewen_2_end="飞下",
        yuewen_to_distribute="飞下下",
        yuewen_1_to_append="飞下",
        yuewen_2_to_prepend="下",
        difficulty=1,
    ),
    DistributeTestCase(
        zhongwen_1="再右拐窝打老道向女人街方向飞⋯",
...
distribute_test_cases_block_2 = [
    ...
    DistributeTestCase(
        ...
        yuewen_1_start="",
        zhongwen_2="春田花花幼稚园？",
        yuewen_2_end="咁春田幼稚园呢",
        yuewen_to_distribute="旧中桥百货公司楼上",
        yuewen_1_to_append="旧中桥百货公司楼上",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        ...
        yuewen_1_start="",
        zhongwen_2="春田花花幼稚园？",
        yuewen_2_end="嗰间春田花花幼稚园呀",
        yuewen_to_distribute="银城美食广场附近",
        yuewen_1_to_append="银城美食广场附近",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        zhongwen_1="西人教英文？",
        ...
        zhongwen_2="是呀！",
        yuewen_2_end="",
        yuewen_to_distribute="春田花花",
        yuewen_1_to_append="春田花花",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        zhongwen_1="西人教英文？",
        ...
        zhongwen_2="是呀！",
        yuewen_2_end="",
        yuewen_to_distribute="春田",
        yuewen_1_to_append="春田",
        yuewen_2_to_prepend="",
    ),
]  # distribute_test_cases_block_2
distribute_test_cases_block_3 = [
    DistributeTestCase(
        ...
        zhongwen_2="就是我，麦兜",
        yuewen_2_end="就系我麦兜",
        yuewen_to_distribute="伟仔嗰个呢",
        yuewen_1_to_append="伟仔嗰个呢",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        zhongwen_1="荔芋火鸭礼！　　荔芋火鸭礼！",
        yuewen_1_start="维护科额摘",
        zhongwen_2="忘记校训九十七⋯　　忘记校训九十七⋯",
        yuewen_2_end="",
        yuewen_to_distribute="关其校门交涉设",
        yuewen_1_to_append="关其校门交涉设",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        ...
        yuewen_2_end="",
        yuewen_to_distribute="都唔好关其校门交涉白",
        yuewen_1_to_append="都唔好关其校门交涉白",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        zhongwen_1="今天的早会主要是跟大家分享",
        yuewen_1_start="嗰个位同学",
        zhongwen_2="一个重要主题：",
        yuewen_2_end="",
    ...
    DistributeTestCase(
        zhongwen_1="横看竖看也不像发哥伟仔的一个⋯",
        yuewen_1_start="小朋友即系横睇掂睇都唔似发哥或者",
        zhongwen_2="就是我，麦兜",
        yuewen_2_end="就系我麦兜",
        yuewen_to_distribute="伟仔嗰个呢",
        yuewen_1_to_append="伟仔嗰个呢",
    ...
    DistributeTestCase(
        ...
        yuewen_1_start="呢个扮紧白兔",
        zhongwen_2="横看竖看也不像发哥伟仔的一个⋯",
        yuewen_2_end="小朋友即系横睇掂睇都唔似发哥或者",
        yuewen_to_distribute="猪养嘅",
        yuewen_1_to_append="猪养嘅",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        zhongwen_1="忘记校训九十七⋯　　忘记校训九十七⋯",
        yuewen_1_start="",
        zhongwen_2="也不能忘记校训九十八！",
        yuewen_2_end="关其校门交涉白",
        yuewen_to_distribute="都唔好",
        yuewen_1_to_append="都唔好",
        yuewen_2_to_prepend="",
    ),
    DistributeTestCase(
        zhongwen_1="忘记校训九十七⋯　　忘记校训九十七⋯",
        ...
        yuewen_to_distribute="都唔好",
        yuewen_1_to_append="",
        yuewen_2_to_prepend="都唔好",
    ),
    DistributeTestCase(
        zhongwen_1="也不能忘记校训九十八！",
        yuewen_1_start="都唔好关其校门",
        zhongwen_2="也不能忘记校训九十八！",
        yuewen_2_end="都唔好关其校门交涉",
        yuewen_to_distribute="交涉白",
        yuewen_1_to_append="",
        yuewen_2_to_prepend="交涉白",
    ),
]  # distribute_test_cases_block_3
