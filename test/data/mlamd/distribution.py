...
distribute_test_cases_block_2 = [
    ...
    DistributeTestCase(
        ...
        one_yuewen_to_append="旧中桥百货公司楼上嗰间",
        two_yuewen_to_prepend="",
        verified=True,
    ),
    DistributeTestCase(
        ...
        one_yuewen_to_append="银城美食广场附近嗰间",
        two_yuewen_to_prepend="",
        verified=True,
    ),
]  # distribute_test_cases_block_2
...
distribute_test_cases_block_7 = [
    ...
    DistributeTestCase(
        ...
        two_yuewen_end="所有嗰啲嘢都几好AllThingsBrightandBeautiful",
