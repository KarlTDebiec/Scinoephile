...
- 王菲 / 陳慧琳：Miss Chan 想成為嘅香港歌手，唔好寫成「王妃」或者「陳維林」。
- 阿輝、菇時（Goosie）、得巴（Darby）、阿Ｍａｙ、阿Ｊｕｎｅ：春田花花幼稚園
  點名時出現嘅同學。只喺實際語音同 ASR 近似讀音支持時採用呢啲寫法；唔好用名單補寫
  冇講出嚟嘅人名。常見點名次序包括麥嘜、阿輝、菇時、得巴、阿Ｍａｙ、阿Ｊｕｎｅ。
