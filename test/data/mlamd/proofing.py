...
proof_test_cases_block_58 = [
    ...
    ProofTestCase(
        ...
        "of '悄悄' in the 中文, while '净计计' is a likely mishearing; replaced '劈咗' with '撇咗'.",
        difficulty=3,
        verified=True,
    ),
    ProofTestCase(
...
proof_test_cases_block_61 = [
    ...
    ProofTestCase(
        ...
        note="Corrected '退车仔' to '推车仔' as '退车仔' is a mishearing of "
        "'推车仔', which matches the meaning of '点心车' in the 中文.",
        difficulty=2,
        verified=True,
    ),
    ProofTestCase(
...
proof_test_cases_block_68 = [
    ...
    ProofTestCase(
        ...
        note="Corrected '个' to '嘅' as it is a mishearing, matching the meaning in the 中文; corrected 'Doccom' to 'dot com' as it is a mishearing of the "
