...
# ruff: noqa: E501
test_cases = [
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
    ...
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="转呀，转⋯再更正一下",
        ronghe="转呀，转⋯再更正一下：",
        beizhu="包括了 Google Lens 中存在但 PaddleOCR 中不存在的冒号。",
        difficulty=1,
        verified=True,
    ),
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="飞呀 飞．",
        ronghe="飞呀，飞⋯",
        beizhu="包括了 Google Lens 中存在但 PaddleOCR 中不存在的逗号和省略号；省略了 PaddleOCR "
        "中存在但 Google Lens 中不存在的空格和句号。",
        difficulty=1,
        verified=True,
    ),
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
    ...
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="更正：左边额角上",
        ronghe="更正：左边额角上⋯",
        beizhu="包括了 Google Lens 中存在但 PaddleOCR 中不存在的省略号；省略了 Google Lens OCR "
    ...
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="但总得要叻仔呀 F！",
        ronghe="但总得要叻仔呀！",
        beizhu="省略了 PaddleOCR 中存在但 Google Lens 中不存在的“F”。",
        difficulty=1,
        verified=True,
    ),
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        beizhu="包括了 Google Lens 中存在但 PaddleOCR 中不存在的引号「；省略了 PaddleOCR 中存在但 "
        "Google Lens 中不存在的空格。",
        difficulty=1,
        verified=True,
    ),
    ...
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="不行，月 胶胶声，多难听！",
        ronghe="不行，胶胶声，多难听！",
        beizhu="省略了 PaddleOCR 中存在但 Google Lens 中不存在的“月”字和多余的空格。",
        difficulty=1,
        verified=True,
    ),
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
    ...
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="鹅满是快烙滴好耳痛＂",
        ronghe="鹅满是快烙滴好耳痛⋯",
        beizhu="采用了 Google Lens 识别的汉字和省略号，未采用 PaddleOCR 末尾的引号。",
        difficulty=1,
        verified=True,
    ),
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
        ...
        paddle="鹅闷天天一戏个窗！",
        ronghe="〝鹅闷天天一戏个窗！〞",
        beizhu="包括了 Google Lens 中存在但 PaddleOCR 中不存在的引号。",
        difficulty=1,
        verified=True,
    ),
    ZhongwenFusionTestCase.get_test_case_cls(ZhongwenFusionSimplifiedPrompt)(
