...
test_case_block_4 = EnglishProofTestCase.get_test_case_cls(55)(
    ...
    revised_6="also, she is a Faye Wong wannabe.",
    note_6="Changed 'Also' to lowercase to continue sentence from previous subtitle.",
    revised_7="actually, Kelly Chan will do!",
    note_7="Changed 'Actually' to lowercase to continue sentence from "
    "previous subtitle.",
    revised_36="I keep feeling that.",
    note_36="Changed '1' to 'I'.",
    revised_47="There are so many things that\nI don't understand.",
    note_47="Changed 'SO' to 'so'.",
    revised_49="One day, when I finish kindergarten...",
    note_49="Changed '..' to '...'.",
    revised_51="And get my degree.",
    note_51="Added period at end for consistency.",
    difficulty=1,
)  # test_case_block_4
# noinspection PyArgumentList
