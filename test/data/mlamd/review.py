...
review_test_case_block_0 = ReviewTestCase.get_test_case_cls(33)(
    ...
    yuewen_19="胶兜对麦太嘅愿望似乎冇咩表示噃",
    zhongwen_20="于是她向胶兜补充说：",
    yuewen_20="于是，佢对住胶兜补充噉话：",
    ...
    note_5="Changed '都系唔好：' to '更正一下：' to match the correction theme and "
    "maintain consistency with the other correction lines in the "
    "series.",
    yuewen_revised_6="",
    note_6="",
    yuewen_revised_7="转呀，转⋯更正一下：",
    note_7="Changed '转下，转下⋯都系唔好：都系' to '转呀，转⋯更正一下：' to match the "
    "correction format and maintain consistency with the other "
    "correction lines in the series.",
    yuewen_revised_8="",
    note_8="",
    yuewen_revised_9="",
    note_9="",
    ...
    note_13="Changed '都系唔好：左边魂精对上⋯' to '更正：左边额角对上⋯' to match the "
    "correction format and use the correct anatomical term, "
...
review_test_case_block_2 = ReviewTestCase.get_test_case_cls(16)(
    zhongwen_1="麦太，没见面一阵",
    yuewen_1="咦，麦太，好耐冇见你一排",
    zhongwen_2="怎么小腿粗起来了？",
    yuewen_2="个个小腿粗咗咁多呀？鬼咩",
    zhongwen_3="可怜呀，每天扑来扑去⋯",
    yuewen_3="日日扑嚟扑去⋯",
    zhongwen_4="替儿子找幼稚园！",
    yuewen_4="同我仔揾幼稚园吖嘛！",
    zhongwen_5="怎么不试一试好彩酒楼对面",
    yuewen_5="点解唔试下好彩酒楼斜对面旧中桥百货公司楼上",
    zhongwen_6="旧中侨国货楼上的⋯",
    yuewen_6="咁⋯",
    zhongwen_7="春田花花幼稚园？",
    yuewen_7="春田，幼稚园呢？",
    zhongwen_8="就是座落界限街南昌街交界⋯",
    yuewen_8="就系座落喺界限街同南昌街交界⋯",
    zhongwen_9="银城美食广场附近的⋯",
    yuewen_9="银城美食广场附近⋯",
    zhongwen_10="春田花花幼稚园？",
    yuewen_10="嗰间春田花花幼稚园呀？",
    zhongwen_11="对！深水埗地铁站步行不用10分钟！",
    yuewen_11="啱呀！喺深水埗地铁站行过去都唔使十分钟㗎！",
    zhongwen_12="春田花花幼稚园，师资优良⋯",
    yuewen_12="春田花花幼稚园，师资好正㗎⋯",
    ...
    yuewen_16="春田花花，真系有唔少鬼佬㗎！",
    yuewen_revised_1="",
    note_1="",
    yuewen_revised_2="点解你只小腿粗咗咁多呀？鬼咩",
    note_2="Changed '个个小腿' to '你只小腿' for consistency with the context "
    "and to match the likely intended meaning (referring to the "
    "person being addressed, not 'everyone').",
    yuewen_revised_3="",
    note_3="",
    yuewen_revised_4="",
    note_4="",
    yuewen_revised_5="点解唔试下好彩酒楼对面旧中侨百货公司楼上",
    note_5="Changed '斜对面' to '对面' and '中桥' to '中侨' to match the "
    "referenced location in the rest of the series and maintain "
    "consistency with the proper name.",
    yuewen_revised_6="旧中侨国货公司楼上嗰间⋯",
    note_6="Expanded to '旧中侨国货公司楼上嗰间⋯' for clarity and consistency with "
    "the previous and following lines, referencing the location "
    "explicitly.",
    yuewen_revised_7="春田花花幼稚园？",
    note_7="Changed '春田，幼稚园呢？' to '春田花花幼稚园？' for consistency with the "
    "name used throughout the series.",
    yuewen_revised_8="",
    note_8="",
    yuewen_revised_9="",
    note_9="",
...
review_test_case_block_3 = ReviewTestCase.get_test_case_cls(23)(
    ...
    yuewen_revised_4="",
    note_4="",
    yuewen_revised_5="呢个猪样白兔小朋友⋯",
    note_5="Added '呢个' at the beginning to match the structure of the "
    "other lines and for consistency with the original.",
    yuewen_revised_6="",
    note_6="",
    yuewen_revised_7="",
    note_7="",
