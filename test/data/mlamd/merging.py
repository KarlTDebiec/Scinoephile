...
merge_test_cases_block_43 = [
    ...
    MergeTestCase(
        ...
        yuewen_merged="哦，我前三万苦嚟到长洲揾嚟近⋯哦，我终于可以同山神一齐练习",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="我终于可以跟珊珊一起练滑浪风帆了！",
        yuewen_to_merge=["玩弄风范啊", "我将杯茶递咗畀嚟跟"],
        yuewen_merged="玩弄风范啊，我将杯茶递咗畀嚟跟！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="我将茶递给黎根，黎根他⋯",
        yuewen_to_merge=["嚟跟佢", "亦唔系"],
        yuewen_merged="嚟跟佢，亦唔系⋯",
        difficulty=1,
    ),
    MergeTestCase(
...
merge_test_cases_block_45 = [
    ...
    MergeTestCase(
        zhongwen="「抢包山」从此被禁！",
        yuewen_to_merge=["都去抢包山", "而"],
        yuewen_merged="都去抢包山，而！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="而长洲独有的传统，亦渐被遗忘",
        yuewen_to_merge=["长洲特有嘅传统亦占备为榜", "长洲特有嘅传统亦占备为榜"],
        yuewen_merged="长洲特有嘅传统，亦占备为榜长洲特有嘅传统亦占备为榜",
        difficulty=1,
    ),
]  # merge_test_cases_block_45
...
merge_test_cases_block_51 = [
    ...
    MergeTestCase(
        ...
        yuewen_merged="但系见到佢一条条凸起嘅青筋唔知点解⋯",
        difficulty=2,
    ),
    MergeTestCase(
...
merge_test_cases_block_52 = [
    MergeTestCase(
        ...
        yuewen_merged="我揾完成间屋，都揾唔到部电子英文词典",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="跑哪去了？",
...
merge_test_cases_block_53 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["于是我让返电子词典", "将封信译返做中文", "封信原来系"],
        yuewen_merged="于是我让返电子词典，将封信译返做中文封信原来系",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="信，是妈妈写给奥委会主席的",
        yuewen_to_merge=["妈妈写畀奥委会主席㗎"],
        yuewen_merged="妈妈写畀奥委会主席㗎",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="「亲爱的主席：」",
...
merge_test_cases_block_54 = [
    ...
    MergeTestCase(
        ...
        yuewen_merged="最后，我终于练成「十二路抢包手」啦",
        difficulty=2,
    ),
]  # merge_test_cases_block_54
merge_test_cases_block_55 = [
    ...
    MergeTestCase(
        zhongwen="我说：火鸡「疴烂煮」！",
        yuewen_to_merge=["我话", "火鸡我能住呀", "火鸡好勉强"],
        yuewen_merged="我话：火鸡我能住呀，火鸡好勉强！",
        difficulty=2,
    ),
    MergeTestCase(
...
merge_test_cases_block_58 = [
    ...
    MergeTestCase(
        ...
        yuewen_merged="我仲发觉到，火鸡嘅味道⋯味食同食第一啖之间，已经系佢嘅最高峰",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="将吃未吃和第一口之间已经是最高峰",
        yuewen_to_merge=["之后", "不过都系食开就食埋落去"],
        yuewen_merged="之后，不过都系食开就食埋落去",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="我没有哲学家的头脑⋯",
...
merge_test_cases_block_64 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["揸住个包"],
        yuewen_merged="揸住个包⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="揸住个包，我忽然明白⋯",
        yuewen_to_merge=["我忽然明白"],
        yuewen_merged="我忽然明白⋯",
        difficulty=2,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        zhongwen="原来蠢，并不那么好笑",
        yuewen_to_merge=["原来", "唔系咁好笑", "会失败"],
        yuewen_merged="原来，唔系咁好笑会失败",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="失望，并不那么好笑",
        yuewen_to_merge=["失望", "唔系咁好笑"],
        yuewen_merged="失望唔系咁好笑",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="肥，都不一定好笑",
...
merge_test_cases_block_69 = [
    MergeTestCase(
        zhongwen="麻烦你，一客常餐",
        yuewen_to_merge=["唔该", "我要一个常餐啦", "常餐"],
        yuewen_merged="唔该我要一个常餐啦常餐",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="常餐？常餐有什么吃？",
        yuewen_to_merge=["常餐有咩食㗎"],
        yuewen_merged="常餐有咩食㗎？",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="特餐是什么？",
