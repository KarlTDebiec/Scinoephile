...
merge_test_cases_block_4 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["点解雨姐会叫做暗芭拉娜呢", "嗱", "我暗啦"],
        yuewen_merged="点解雨姐会叫做「暗芭拉娜」呢？嗱，我暗啦",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="我「暗」的「暗」掉一条蕉",
        yuewen_to_merge=["噉我暗𠮶条香蕉", "至多会Orange啫"],
        yuewen_merged="噉我「暗」𠮶条香蕉，至多会Orange啫",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="至多是疴烂煮，怎么会下起雨来呢？",
        yuewen_to_merge=["点解会搞到落雨呢"],
        yuewen_merged="点解会搞到落雨呢？",
        difficulty=2,
    ),
    MergeTestCase(
...
merge_test_cases_block_7 = [
    ...
    MergeTestCase(
        zhongwen="世上一切，一切一切⋯",
        yuewen_to_merge=["世上一切", "所有𠮶啲嘢", "都几好"],
        yuewen_merged="世上一切，所有𠮶啲嘢，都几好⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="所有那些，都好！",
        yuewen_to_merge=["All", "Things", "Bright", "and", "Beautiful"],
        yuewen_merged="All Things Bright and Beautiful！",
        difficulty=2,
    ),
]  # merge_test_cases_block_7
...
merge_test_cases_block_12 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["例如每晚临睡前", "佢都会讲故事畀我听", "从前"],
        yuewen_merged="例如每晚临睡前，佢都会讲故事畀我听，从前",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="从前，有个小朋友撒谎；有一天⋯",
        yuewen_to_merge=["有个小朋友讲大话", "有一日"],
        yuewen_merged="有个小朋友讲大话；有一日⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="他死了！",
...
merge_test_cases_block_16 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["𠮶度啲可能几份好大碟㗎", "系喇系喇"],
        yuewen_merged="𠮶度啲可能几份好大碟㗎，系喇系喇",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="对了，那地方叫银城中心",
        yuewen_to_merge=["𠮶间叫做银城中心"],
        yuewen_merged="𠮶间叫做银城中心",
        difficulty=2,
    ),
    MergeTestCase(
