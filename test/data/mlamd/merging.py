...
merge_test_cases_block_2 = [
    ...
    MergeTestCase(
        zhongwen="旧中侨国货楼上的⋯",
        yuewen_to_merge=["旧中桥百货公司楼上嗰间"],
        yuewen_merged="旧中桥百货公司楼上嗰间⋯",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        zhongwen="银城美食广场附近的⋯",
        yuewen_to_merge=["银城美食广场附近嗰间"],
        yuewen_merged="银城美食广场附近嗰间⋯",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_3 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["即系横睇掂睇都唔似发哥或者", "位仔嗰个呢"],
        yuewen_merged="即系横睇掂睇都唔似发哥或者位仔嗰个呢⋯",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_12 = [
    ...
    MergeTestCase(
        zhongwen="再包包包，纸纸纸",
        yuewen_to_merge=["再包包包包", "包鸡包纸", "包纸", "纸纸纸纸", "纸包纸"],
        yuewen_merged="再包包包包包鸡包纸包纸，纸纸纸纸纸包纸",
        difficulty=3,
        verified=True,
    ),
    MergeTestCase(
        zhongwen="纸包纸，纸包鸡，鸡包纸，纸包鸡⋯",
        yuewen_to_merge=["纸包鸡", "包鸡纸", "纸包鸡", "鸡鸡鸡", "纸纸纸再包鸡鸡"],
        yuewen_merged="纸包鸡，包鸡纸，纸包鸡，鸡鸡鸡，纸纸纸再包鸡鸡⋯",
        difficulty=3,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_22 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["妈妈我唔系讲喇㗎", "又系你话嘅"],
        yuewen_merged="妈妈我唔系讲喇㗎，又系你话嘅⋯",
        difficulty=2,
        prompt=True,
        verified=True,
    ),
    MergeTestCase(
        ...
        yuewen_to_merge=["你话我病好咗之日就同我去马尔代夫㗎", "你讲过㗎"],
        yuewen_merged="你话我病好咗之日就同我去马尔代夫㗎！你讲过㗎！",
        difficulty=2,
        prompt=True,
        verified=True,
    ),
    MergeTestCase(
        ...
        yuewen_merged="唔系㖞，妈妈你话好咗就同我去㗎㖞",
        difficulty=2,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_23 = [
    MergeTestCase(
        zhongwen="麦唛，我是麦兜呀",
        yuewen_to_merge=["喂", "麦麦啊", "麦豆啊我系"],
        yuewen_merged="喂，麦麦啊，麦豆啊我系",
        difficulty=2,
        verified=True,
    ),
    MergeTestCase(
        zhongwen="是这样子的，我明天就飞了",
        yuewen_to_merge=["即系呢我明日就要飞喇"],
        yuewen_merged="即系呢，我明日就要飞喇",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["嗰度蓝天五百云", "夜临雪"],
        yuewen_merged="嗰度蓝天五百云，夜临雪⋯",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
