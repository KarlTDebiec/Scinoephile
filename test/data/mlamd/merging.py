...
merge_test_cases_block_0 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["经过好彩酒家", "再左转返出花园街乐园牛丸望对上"],
        yuewen_merged="经过好彩酒家，再左转返出花园街乐园牛丸望对上⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="更正一下：",
    ...
    MergeTestCase(
        zhongwen="转呀，转⋯再更正一下：",
        yuewen_to_merge=["转下", "转下", "都系唔好", "都系"],
        yuewen_merged="转下，转下⋯都系唔好：都系",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="直出亚皆老街跨过火车桥右转太平道",
        yuewen_to_merge=["出返去阿佳路街飞过火车桥", "右转入太平道"],
        yuewen_merged="出返去阿佳路街飞过火车桥右转入太平道",
    ),
    MergeTestCase(
        zhongwen="再右拐窝打老道向女人街方向飞⋯",
        yuewen_to_merge=["再右转屈返出去窝大路道", "向女人街方向", "飞下"],
        yuewen_merged="再右转屈返出去窝大路道向女人街方向飞下⋯",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="飞呀，飞⋯",
        yuewen_to_merge=["下", "飞下", "飞下"],
        yuewen_merged="下，飞下，飞下⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="也就是在麦太右边额角上⋯",
        yuewen_to_merge=["亦即系默太右边云晶对上"],
        yuewen_merged="亦即系默太右边云晶对上⋯",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="更正：左边额角上⋯",
    ...
    MergeTestCase(
        zhongwen="于是她向胶兜补充说：",
        yuewen_to_merge=["于是", "佢对住胶兜补充噉话"],
        yuewen_merged="于是，佢对住胶兜补充噉话：",
        difficulty=2,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["胶兜依然系噉喺度住", "好似一啲应承嘅迹象都冇"],
        yuewen_merged="胶兜依然系噉喺度住，好似一啲应承嘅迹象都冇",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="赶忙趁胶兜落地前另许一个愿望：",
        yuewen_to_merge=["嗱嗱嗱喺胶兜未落地之前起过另外一个愿望"],
        yuewen_merged="嗱嗱嗱，喺胶兜未落地之前起过另外一个愿望：",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="唔聪明唔靓仔也算了，只要福星高照",
        yuewen_to_merge=["就算唔系咁聪明同咁靓仔", "只要复星高照", "一世旧运"],
        yuewen_merged="就算唔系咁聪明同咁靓仔，只要复星高照，一世旧运",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="一世够运，逢凶化吉！",
        yuewen_to_merge=["乜嘢事都逢凶发㗎喇"],
        yuewen_merged="乜嘢事都逢凶发㗎喇！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="虽是说像梁朝伟周润发也行运定了",
        yuewen_to_merge=["虽然似梁朝伟周润发", "都唔返去冒运行"],
        yuewen_merged="虽然似梁朝伟周润发，都唔返去冒运行",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="但总得要叻仔呀！",
        yuewen_to_merge=["但系都要靓仔先得㗎"],
        yuewen_merged="但系都要靓仔先得㗎！",
        difficulty=1,
    ),
]  # merge_test_cases_block_0
...
merge_test_cases_block_2 = [
    ...
    MergeTestCase(
        zhongwen="怎么小腿粗起来了？",
        yuewen_to_merge=["个个官房粗咗咁多呀", "鬼咩"],
        yuewen_merged="个个官房粗咗咁多呀？鬼咩",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="可怜呀，每天扑来扑去⋯",
        yuewen_to_merge=["日日扑嚟扑去"],
        yuewen_merged="日日扑嚟扑去⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="替儿子找幼稚园！",
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["点解唔试下好彩走楼斜对面", "旧中桥百货公司楼上"],
        yuewen_merged="点解唔试下好彩走楼斜对面旧中桥百货公司楼上",
    ),
    MergeTestCase(
        zhongwen="旧中侨国货楼上的⋯",
        yuewen_to_merge=["咁"],
    ...
    MergeTestCase(
        zhongwen="春田花花幼稚园？",
        yuewen_to_merge=["春田", "幼稚园呢"],
        yuewen_merged="春田，幼稚园呢？",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="就是座落界限街南昌街交界⋯",
        yuewen_to_merge=["就系座落喺界限街同南昌街交界"],
        yuewen_merged="就系座落喺界限街同南昌街交界⋯",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="银城美食广场附近的⋯",
        yuewen_to_merge=["银城美食广场附近"],
        yuewen_merged="银城美食广场附近⋯",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="春田花花幼稚园？",
        yuewen_to_merge=["嗰间春田花花幼稚园呀"],
        yuewen_merged="嗰间春田花花幼稚园呀？",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="对！深水埗地铁站步行不用10分钟！",
        yuewen_to_merge=["唔系", "又睇下", "系唔系食"],
        yuewen_merged="唔系！又睇下，系唔系食！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="而且还有西人教英文！",
        yuewen_to_merge=["都嚟㖞", "唔", "春田"],
        yuewen_merged="都嚟㖞，唔，春田！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="是呀！",
...
merge_test_cases_block_3 = [
    MergeTestCase(
        zhongwen="〝鹅闷是春天滴化！〞",
        yuewen_to_merge=["呢个扮紧白兔"],
        yuewen_merged="呢个扮紧白兔〞",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="这个猪样白兔小朋友⋯",
        yuewen_to_merge=["猪养嘅", "小朋友", "即系"],
        yuewen_merged="猪养嘅小朋友即系⋯",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="横看竖看也不像发哥伟仔的一个⋯",
        yuewen_to_merge=["横睇掂睇都唔似发哥或者", "伟仔嗰个呢"],
        yuewen_merged="横睇掂睇都唔似发哥，或者伟仔嗰个呢⋯",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="就是我，麦兜",
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["维护科额摘", "关其校门交涉设"],
        yuewen_merged="维护科额摘！　　关其校门交涉设！",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="也不能忘记校训九十八！",
        yuewen_to_merge=["都唔好", "关其校门", "交涉白"],
        yuewen_merged="都唔好，关其校门，交涉白！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="也不能忘记校训九十八！",
        yuewen_to_merge=["都唔好关其校门交涉"],
        yuewen_merged="都唔好关其校门交涉！",
        difficulty=1,
    ),
    MergeTestCase(
        zhongwen="好！各位同学⋯",
    ...
    MergeTestCase(
        zhongwen="交过了！",
        yuewen_to_merge=["哎", "好在", "噉"],
        yuewen_merged="哎，好在噉！",
        difficulty=2,
    ),
    MergeTestCase(
        zhongwen="太好了！大家去上堂吧",
        yuewen_to_merge=["大家可以返去上堂啦"],
        yuewen_merged="大家可以返去上堂啦！",
        difficulty=1,
    ),
]  # merge_test_cases_block_3
merge_test_cases_block_4 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["嗱", "我暗啦", "噉我暗嗰条香蕉"],
        yuewen_merged="嗱，我「暗」啦，噉我「暗」嗰条香蕉",
        difficulty=2,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_7 = [
    ...
    MergeTestCase(
        ...
        yuewen_merged="所有嗰啲嘢，都几好！All Things Bright and Beautiful",
        difficulty=2,
        verified=True,
    ),
]  # merge_test_cases_block_7
...
merge_test_cases_block_9 = [
    ...
    MergeTestCase(
        ...
        yuewen_merged="除咗做保险，地产经纪同埋trading之外⋯",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
...
merge_test_cases_block_12 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["再包包包包", "包住个纸包鸡", "再包包包"],
        yuewen_merged="再包包包包包住个纸包鸡再包包包",
        verified=True,
    ),
    MergeTestCase(
        zhongwen="再包包包，纸纸纸",
...
merge_test_cases_block_16 = [
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["嗰度好迪士尼呢", "同埋HelloTT呢"],
        yuewen_merged="嗰度好迪士尼呢同埋HelloTT呢",
        difficulty=2,
        verified=True,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["嗰度有好多水晶活动㗎", "仲有一次食添㖞"],
        yuewen_merged="嗰度有好多水晶活动㗎，仲有一次食添㖞",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        zhongwen="就是那间什么！",
        yuewen_to_merge=["就系嗰间咩嚟啰"],
        yuewen_merged="就系嗰间咩嚟啰！",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
    ...
    MergeTestCase(
        ...
        yuewen_to_merge=["系喇系喇", "嗰间叫做银城中心"],
        yuewen_merged="系喇系喇，嗰间叫做银城中心",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
        zhongwen="那店子的饭很多，很大碟的！",
        yuewen_to_merge=["嗰间嘢啲饭好多人", "好大碟㗎"],
        yuewen_merged="嗰间嘢啲饭好多人，好大碟㗎！",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
        zhongwen="不过说到我最想去的地方，那可厉害了",
        yuewen_to_merge=["不过讲到我最想去嘅地方呢", "嗰度细嚟啰"],
        yuewen_merged="不过讲到我最想去嘅地方呢，嗰度细嚟啰",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
        zhongwen="那儿蓝天白云，椰林树影，水清沙幼",
        yuewen_to_merge=["嗰度南天白云", "夜临树影", "水清沙幽"],
        yuewen_merged="嗰度南天白云，夜临树影，水清沙幽",
        difficulty=1,
        verified=True,
    ),
    MergeTestCase(
