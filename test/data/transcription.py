...
def process_yue_hans_transcription(  # noqa: PLR0912, PLR0915
    ...
    *,
    ...
    if reference is not None:
        ...
        print(SeriesCERResult(reference, transcribe))
    ...
    if reference is not None:
        ...
        print(SeriesCERResult(reference, line_review))
    ...
    if reference is not None:
        ...
        print(SeriesCERResult(reference, translate))
    ...
    if reference is not None:
        ...
        print(SeriesCERResult(reference, block_review))
