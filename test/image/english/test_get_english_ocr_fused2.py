...
from scinoephile.image.english.fusion import get_english_ocr_fused2
...
def _test_get_english_ocr_fused(lens: Series, tesseract: Series, expected: Series):
    ...
    """
    output = get_english_ocr_fused2(lens, tesseract)
...
def test_get_english_ocr_fused_kob(
    ...
    _test_get_english_ocr_fused(lens, tesseract, kob_eng_fuse)
...
def test_get_english_ocr_fused_mlamd(
    ...
    _test_get_english_ocr_fused(lens, tesseract, mlamd_eng_fuse)
...
def test_get_english_ocr_fused_mnt(
    ...
    _test_get_english_ocr_fused(lens, tesseract, mnt_eng_fuse)


def test_get_english_ocr_fused_t(
    t_eng_lens: Series, t_eng_tesseract: Series, t_eng_fuse: Series
):
    ...
    _test_get_english_ocr_fused(lens, tesseract, t_eng_fuse)
