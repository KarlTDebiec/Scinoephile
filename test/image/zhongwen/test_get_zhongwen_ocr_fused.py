...
from scinoephile.image.zhongwen.fusion import get_zhongwen_ocr_fused


def _test_get_zhongwen_ocr_fused(paddle: Series, lens: Series, expected: Series):
    """Test get_zhongwen_ocr_fused.

    Arguments:
        paddle: subtitles OCRed using Tesseract
        lens: subtitles OCRed using Google Lens
        expected: expected output series
    """
    output = get_zhongwen_ocr_fused(paddle, lens)

    assert len(paddle) == len(output)
...
def test_get_zhongwen_ocr_fused_kob(
    kob_zho_hant_paddle: Series, kob_zho_hant_lens: Series, kob_zho_hant_fuse: Series
):
    ...
    _test_get_zhongwen_ocr_fused(paddle, lens, kob_zho_hant_fuse)
...
def test_get_zhongwen_ocr_fused_mlamd(
    ...
    _test_get_zhongwen_ocr_fused(paddle, lens, mlamd_zho_hans_fuse)


def test_get_zhongwen_ocr_fused_mnt(
    mnt_zho_hans_paddle: Series, mnt_zho_hans_lens: Series, mnt_zho_hans_fuse: Series
):
    ...
    lens = get_zhongwen_converted(lens)
    _test_get_zhongwen_ocr_fused(paddle, lens, mnt_zho_hans_fuse)


def test_get_zhongwen_ocr_fused_t(
    t_zho_hans_paddle: Series, t_zho_hans_lens: Series, t_zho_hans_fuse: Series
):
    ...
    lens = get_zhongwen_converted(lens)
    _test_get_zhongwen_ocr_fused(paddle, lens, t_zho_hans_fuse)
