...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ScinoephileCli, CmnYueDictionaryCli, CmnYueDictionarySearchCli),
    ],
)
...
@skip_if_ci()
@skip_if_no_network()
def test_cmn_yue_dictionary_search_cli_traditional(
    cuhk_traditional_query: str, cuhk_database_path: Path
):
    """Test CUHK dictionary search CLI using an unambiguous traditional query."""
