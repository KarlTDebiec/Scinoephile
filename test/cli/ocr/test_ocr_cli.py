...
def test_ocr_lens_cli_converts_image_subtitles_to_srt(
    ...
    def fake_ocr_image_series_with_lens(*args: object, **kwargs: Any) -> Series:
    ...
    run_cli_with_args(
        ...
        f"--language zho-Hans --retries 5 --cache-dir {cache_root_path}",
    )
...
def test_ocr_paddle_cli_converts_image_subtitles_to_srt(
    ...
    def fake_ocr_image_series_with_paddle(*args: object, **kwargs: Any) -> Series:
...
def test_ocr_tesseract_cli_converts_image_subtitles_to_srt(
    ...
    def fake_ocr_image_series_with_tesseract(*args: object, **kwargs: Any) -> Series:
    ...
    run_cli_with_args(
        OcrTesseractCli,
        f"--infile {input_path} --outfile {output_path} --cache-dir {cache_root_path}",
    )
...
def test_ocr_tesseract_cli_rejects_italic_detection_for_non_english(
    ...
    def fail_ocr_image_series_with_tesseract(*args: object, **kwargs: Any) -> Series:
...
def test_ocr_engine_clis_delegate_subtitle_outputs_to_writer(
    ...
    def fake_ocr_image_series(*args: object, **kwargs: Any) -> Series:
    ...
    run_cli_with_args(
        ...
        f"--overwrite --cache-overwrite --cache-dir {cache_root_path}",
    )
    ...
    expected_ocr_kwargs["cache_root_path"] = cache_root_path.resolve()
