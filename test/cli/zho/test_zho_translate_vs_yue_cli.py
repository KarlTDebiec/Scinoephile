...
"""Tests of scinoephile.cli.zho.zho_translate_vs_yue_cli."""
...
def test_zho_translate_vs_yue_cli_gapped_translation():
    ...
    with get_temp_file_path(".srt") as output_path:
        with patch(
            "scinoephile.cli.zho.zho_translate_vs_yue_cli."
...
def test_zho_translate_vs_yue_cli_regular_translation():
    ...
    with get_temp_file_path(".srt") as output_path:
        with patch(
            "scinoephile.cli.zho.zho_translate_vs_yue_cli.get_zho_yue_translator",
            return_value="translator",
        ) as patched_factory:
            with patch(
                "scinoephile.cli.zho.zho_translate_vs_yue_cli."
