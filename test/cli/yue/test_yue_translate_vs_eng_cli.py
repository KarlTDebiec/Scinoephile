...
"""Tests of scinoephile.cli.yue.yue_translate_vs_eng_cli."""
...
def test_yue_translate_vs_eng_cli_gapped_translation():
    ...
    with get_temp_file_path(".srt") as output_path:
        with patch(
            "scinoephile.cli.yue.yue_translate_vs_eng_cli."
...
def test_yue_translate_vs_eng_cli_regular_translation():
    ...
    with get_temp_file_path(".srt") as output_path:
        with patch(
            "scinoephile.cli.yue.yue_translate_vs_eng_cli.get_yue_eng_translator",
            return_value="translator",
        ) as patched_factory:
            with patch(
                "scinoephile.cli.yue.yue_translate_vs_eng_cli."
