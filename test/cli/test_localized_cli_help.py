...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("zh-hans", "multi cer", "计算一个序列相对于另一个序列的字符错误率（CER）"),
        ("zh-hant", "multi cer", "計算一個序列相對於另一個序列的字元錯誤率（CER）"),
        ("en", "multi diff", "Calculate the diff between two series"),
        ("zh-hans", "multi diff", "计算两个序列之间的差异"),
        ("zh-hant", "multi diff", "計算兩個序列之間的差異"),
        ...
        ("en", "utility", "Run utility commands"),
        ("zh-hans", "utility", "运行实用工具命令"),
        ("zh-hant", "utility", "執行實用工具命令"),
        ("en", "utility cache", "Inspect and invalidate local caches"),
        ("zh-hans", "utility cache", "检查并清除本地缓存"),
        ("zh-hant", "utility cache", "檢查並清除本機快取"),
        (
            "en",
        ...
        ("en", "eng translate-vs-zho", "Translate English subtitles using Chinese"),
        ("zh-hans", "eng translate-vs-zho", "使用中文字幕和英文参考翻译英文字幕"),
        ("zh-hant", "eng translate-vs-zho", "使用中文字幕與英文參考翻譯英文字幕"),
