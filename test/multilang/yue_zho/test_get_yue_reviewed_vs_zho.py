...
def _test_get_yue_reviewed_vs_zho(yuewen: Series, zhongwen: Series, expected: Series):
    """Test get_yue_reviewed_vs_zho function.
    ...
    """
    output = get_yue_reviewed_vs_zho(yuewen, zhongwen)
