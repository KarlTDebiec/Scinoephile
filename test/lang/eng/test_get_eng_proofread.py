...
def test_get_eng_proofread_kob(
    ...
    Arguments:
        ...
        kob_eng_fuse_clean_validate_review: Expected proofread KOB English series
          fixture
    """
...
def test_get_eng_proofread_mlamd(
    ...
    Arguments:
        ...
        mlamd_eng_fuse_clean_validate_review: Expected proofread MLAMD English series
          fixture
    """
    _test_get_eng_proofread(
        mlamd_eng_fuse_clean_validate, mlamd_eng_fuse_clean_validate_review
    )
...
def test_get_eng_proofread_mnt(
    ...
    Arguments:
        ...
        mnt_eng_fuse_clean_validate_review: Expected proofread MNT English series
          fixture
    """
    _test_get_eng_proofread(
...
def test_get_eng_proofread_t(
    ...
    Arguments:
        ...
        t_eng_fuse_clean_validate_review: Expected proofread T English series fixture
    """
    _test_get_eng_proofread(
