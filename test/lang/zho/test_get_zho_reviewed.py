...
"""Tests of scinoephile.lang.zho.get_zho_reviewed."""
...
from scinoephile.lang.zho import get_zho_reviewed
...
def _test_get_zho_reviewed(
    ...
    """
    output = get_zho_reviewed(series, processor=processor)
