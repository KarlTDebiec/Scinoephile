...
"""Factories for dual block cardinality LLM classes."""
...
__all__ = ["DualBlockCardinalityManager"]


class DualBlockCardinalityManager(Manager):
    """Factories for dual block cardinality LLM classes."""

    prompt_cls: ClassVar[type[DualBlockCardinalityPrompt]] = DualBlockCardinalityPrompt
    ...
    def get_answer_cls(
        ...
        source_one_size: int,
        source_two_size: int,
        prompt_cls: type[DualBlockCardinalityPrompt] = DualBlockCardinalityPrompt,
    ) -> type[Answer]:
    ...
    def get_test_case_cls_from_data(
        ...
        **kwargs: Unpack[TestCaseClsKwargs],
        ...
        prompt_cls = cast(type[DualBlockCardinalityPrompt], prompt_cls)
