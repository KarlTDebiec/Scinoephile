...
"""Processes dual block cardinality transforms."""
...
__all__ = ["DualBlockCardinalityProcessor"]


logger = getLogger(__name__)


class DualBlockCardinalityProcessor(Processor):
    """Processes dual input blocks where outputs follow source one cardinality."""

    prompt_cls: type[DualBlockCardinalityPrompt]
    ...
    def process(
        ...
        for blk_idx, (one_blk, two_blk) in enumerate(block_pairs):
            ...
            test_case_cls = DualBlockCardinalityManager.get_test_case_cls(
