...
def get_alignment_sha256(artifact: AlignmentArtifact) -> str:
...
class TranscriptionRunBlock(BaseModel):
    ...
    query_keys: tuple[_Sha256, ...] = ()
    """Semantic transcription query-key digests in request order."""


class TranscriptionRunProcessor(BaseModel):
    ...
    """Digest of additional context supplied to the processor."""
