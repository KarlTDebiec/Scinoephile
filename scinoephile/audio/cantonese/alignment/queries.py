...
def get_shifting_test_case(
    ...
    query_kwargs = {
        test_case_cls.prompt_cls.reference_1_field: zw_1,
        test_case_cls.prompt_cls.target_1_field: yw_1,
        test_case_cls.prompt_cls.reference_2_field: zw_2,
        test_case_cls.prompt_cls.target_2_field: yw_2,
    }
