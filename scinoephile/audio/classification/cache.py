...
class AudioClassificationCache:
    ...
    def __init__(
        ...
        Arguments:
            ...
            operation: stable classification operation name
        ...
        self.cache_dir_path = val_output_dir_path(
            self.cache_root_path / "audio" / "classification" / operation
        )
    ...
    def save(
        self, audio: AudioSegment, metadata: Mapping[str, object], result: BaseModel
    ) -> Path:
