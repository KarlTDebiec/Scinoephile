...
class ZhoGappedTranslationVsYuePromptZhoHans(DualNMinusMToNPrompt, PromptZhoHans):
...
class ZhoGappedTranslationVsYuePromptZhoHant(ZhoGappedTranslationVsYuePromptZhoHans):
