...
"""Text for standard Chinese translation from English."""
...
class ZhoTranslationVsEngPromptZhoHans(DualNToMPrompt, PromptZhoHans):
...
class ZhoTranslationVsEngPromptZhoHant(ZhoTranslationVsEngPromptZhoHans):
