...
"""Code related to standard Chinese gapped translation using English."""
...
__all__ = [
    ...
    "ZhoGappedTranslationVsEngPromptZhoHans",
    "ZhoGappedTranslationVsEngPromptZhoHant",
    "ZhoVsEngGappedTranslationProcessKwargs",
    "ZhoVsEngGappedTranslationProcessorKwargs",
    "get_zho_gapped_translated_vs_eng",
    "get_zho_vs_eng_gapped_translator",
]

ZHO_ENG_GAPPED_TRANSLATION_OPERATION_SPEC = OperationSpec(
    operation="zho-eng-gapped-translation",
    test_case_table_name="test_cases__zho_eng__gapped_translation",
...
class ZhoVsEngGappedTranslationProcessKwargs(TypedDict, total=False):
...
class ZhoVsEngGappedTranslationProcessorKwargs(TypedDict, total=False):
...
def get_zho_gapped_translated_vs_eng(
    zhongwen: Series,
    eng: Series,
    translator: DualNMinusMToNProcessor | None = None,
    **kwargs: Unpack[ZhoVsEngGappedTranslationProcessKwargs],
) -> Series:
    """Get standard Chinese subtitle gaps translated using English.
    ...
    Returns:
        standard Chinese with gaps translated using English
    """
    if translator is None:
        translator = get_zho_vs_eng_gapped_translator()
    return translator.process(zhongwen, eng, **kwargs)


def get_zho_vs_eng_gapped_translator(
    prompt_cls: type[ZhoGappedTranslationVsEngPromptZhoHans] = (
        ZhoGappedTranslationVsEngPromptZhoHans
    ),
    test_cases: list[TestCase] | None = None,
    provider: LLMProvider | None = None,
    **kwargs: Unpack[ZhoVsEngGappedTranslationProcessorKwargs],
) -> DualNMinusMToNProcessor:
