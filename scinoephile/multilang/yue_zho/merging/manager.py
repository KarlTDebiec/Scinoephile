...
class YueZhoMergingManager(DualMultiSingleManager):
    ...
    def get_min_difficulty(model: TestCase) -> int:
        ...
        zhongwen = getattr(model.query, model.prompt_cls.src_2, None)
        yuewen_merged = getattr(model.answer, model.prompt_cls.output, None)
    ...
    def validate_test_case(model: TestCase) -> TestCase:
        ...
        yuewen_to_merge = getattr(model.query, model.prompt_cls.src_1, None)
        yuewen_merged = getattr(model.answer, model.prompt_cls.output, None)
