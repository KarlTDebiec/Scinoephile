...
"""Text for translating English from Cantonese with English guidance."""
...
__all__ = ["EngVsYueTranslationPrompt"]


class EngVsYueTranslationPrompt(DualBlockCardinalityPrompt, PromptEng):
    """Text for translating English from Cantonese with English guidance."""

    # Prompt
    base_system_prompt: ClassVar[str] = dedent_and_compact("""
        You are responsible for creating English subtitles from Cantonese subtitles.
        ...
        compatible with the Cantonese. When the Cantonese differs from the original
        English, prioritize the Cantonese.
    ...
    # Query fields
    src_1_pfx: ClassVar[str] = "yue_"
    """Prefix for Cantonese source fields in query."""
