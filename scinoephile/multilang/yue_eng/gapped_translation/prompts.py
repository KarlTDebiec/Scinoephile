...
"""Text for written Cantonese gapped translation using English."""
...
class YueGappedTranslationVsEngPromptYueHans(
...
class YueGappedTranslationVsEngPromptYueHant(YueGappedTranslationVsEngPromptYueHans):
