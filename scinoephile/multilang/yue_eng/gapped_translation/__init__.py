...
"""Code related to written Cantonese gapped translation using English."""
...
__all__ = [
    ...
    "YueGappedTranslationVsEngPromptYueHans",
    "YueGappedTranslationVsEngPromptYueHant",
    "YueVsEngGappedTranslationProcessKwargs",
    "YueVsEngGappedTranslationProcessorKwargs",
    "get_yue_gapped_translated_vs_eng",
    "get_yue_vs_eng_gapped_translator",
]

YUE_ENG_GAPPED_TRANSLATION_OPERATION_SPEC = OperationSpec(
    operation="yue-eng-gapped-translation",
    test_case_table_name="test_cases__yue_eng__gapped_translation",
...
class YueVsEngGappedTranslationProcessKwargs(TypedDict, total=False):
...
class YueVsEngGappedTranslationProcessorKwargs(TypedDict, total=False):
...
def get_yue_gapped_translated_vs_eng(
    yuewen: Series,
    eng: Series,
    translator: DualNMinusMToNProcessor | None = None,
    **kwargs: Unpack[YueVsEngGappedTranslationProcessKwargs],
) -> Series:
    """Get written Cantonese subtitle gaps translated using English.
    ...
    Returns:
        written Cantonese with gaps translated using English
    """
...
def get_yue_vs_eng_gapped_translator(
    prompt_cls: type[YueGappedTranslationVsEngPromptYueHans] = (
        YueGappedTranslationVsEngPromptYueHans
    ),
    test_cases: list[TestCase] | None = None,
    use_dictionary_tool: bool = True,
    provider: LLMProvider | None = None,
    **kwargs: Unpack[YueVsEngGappedTranslationProcessorKwargs],
) -> DualNMinusMToNProcessor:
