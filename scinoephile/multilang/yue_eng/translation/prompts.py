...
"""Text for written Cantonese translation from English."""
...
class YueTranslationVsEngPromptYueHans(
...
class YueTranslationVsEngPromptYueHant(YueTranslationVsEngPromptYueHans):
