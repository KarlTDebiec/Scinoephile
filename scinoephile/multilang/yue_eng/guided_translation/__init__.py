...
"""Code related to guided written Cantonese translation from English."""
...
__all__ = [
    ...
    "YueGuidedTranslationVsEngPromptYueHans",
    "YueGuidedTranslationVsEngPromptYueHant",
    "YueVsEngGuidedTranslationProcessKwargs",
    "YueVsEngGuidedTranslationProcessorKwargs",
    "get_yue_eng_guided_translator",
    "get_yue_translated_from_eng_with_yue_guidance",
]

YUE_ENG_GUIDED_TRANSLATION_OPERATION_SPEC = OperationSpec(
    operation="yue-eng-guided-translation",
    test_case_table_name="test_cases__yue_eng__guided_translation",
    manager_cls=DualNToMManager,
    prompt_cls=YueGuidedTranslationVsEngPromptYueHans,
)
"""Operation specification for guided written Cantonese translation from English."""


class YueVsEngGuidedTranslationProcessKwargs(TypedDict, total=False):
...
class YueVsEngGuidedTranslationProcessorKwargs(TypedDict, total=False):
...
def get_yue_translated_from_eng_with_yue_guidance(
    eng: Series,
    yuewen: Series,
    translator: DualNToMProcessor | None = None,
    **kwargs: Unpack[YueVsEngGuidedTranslationProcessKwargs],
) -> Series:
    """Get written Cantonese subtitles guided-translated from English.
    ...
    Returns:
        written Cantonese subtitles guided-translated from English
    """
...
def get_yue_eng_guided_translator(
    prompt_cls: type[YueGuidedTranslationVsEngPromptYueHans] = (
        YueGuidedTranslationVsEngPromptYueHans
    ),
    test_cases: list[TestCase] | None = None,
    use_dictionary_tool: bool = True,
    provider: LLMProvider | None = None,
    **kwargs: Unpack[YueVsEngGuidedTranslationProcessorKwargs],
) -> DualNToMProcessor:
