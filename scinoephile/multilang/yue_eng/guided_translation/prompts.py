...
"""Text for guided written Cantonese translation from English."""
...
class YueGuidedTranslationVsEngPromptYueHans(
...
class YueGuidedTranslationVsEngPromptYueHant(YueGuidedTranslationVsEngPromptYueHans):
