        ...
        for result in results:
            print(
                "\t".join(
                    [
                        str(result.file_id),
                        _format_optional(result.language),
                        _format_optional(result.download_count),
                        _format_optional(result.rating),
                        _format_optional(result.fps),
                        _format_optional(result.release_name or result.file_name),
                    ]
                )
            )
...
def _format_optional(value: object) -> str:
    """Format an optional value for CLI output.
