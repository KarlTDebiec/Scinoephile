...
class MediaExtractSubsCli(ScinoephileCliBase):
        ...
        *,
        ...
        try:
            if infile_path.suffix.lower() == ".sup":
                if details:
                    streams = cls._get_detailed_subtitle_streams(
                        infile_path,
            ...
            if details:
                subtitle_streams = cls._get_detailed_subtitle_streams(
                    infile_path,
                    cache_dir_path=cache_dir_path,
                )
            else:
    ...
    @staticmethod
    def _get_detailed_subtitle_streams(
        infile_path: Path,
        *,
        cache_dir_path: Path,
    ) -> list[SubtitleStream]:
