...
* dictionary_build_cli_base
* dictionary_build_cuhk_cli / dictionary_build_gzzj_cli
  / dictionary_build_kaifangcidian_cli / dictionary_build_unihan_cli
  / dictionary_build_wiktionary_cli
* dictionary_build_cli
"""
