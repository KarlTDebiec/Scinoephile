...
__all__ = ["YueTranslateFromEngCli"]

YUE_TRANSLATE_FROM_ENG_LOCALIZATIONS: dict[str, dict[str, str]] = {
    "zh-hans": {
        "command-line interface for written Cantonese translation from English": (
            "从英文翻译书面粤语字幕的命令行界面"
        ),
...
class YueTranslateFromEngCli(ScinoephileCliBase):
    """Translate written Cantonese subtitles from English subtitles."""

    localizations = merge_localizations(
        LLM_LOCALIZATIONS,
        YUE_TRANSLATE_FROM_ENG_LOCALIZATIONS,
    )
    """Localized help text keyed by locale and English source text."""
