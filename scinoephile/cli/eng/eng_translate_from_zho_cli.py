...
__all__ = ["EngTranslateFromZhoCli"]

ENG_TRANSLATE_FROM_ZHO_LOCALIZATIONS: dict[str, dict[str, str]] = {
    "zh-hans": {
        "command-line interface for English translation from Chinese": (
            "从中文翻译英文字幕的命令行界面"
        ),
...
class EngTranslateFromZhoCli(ScinoephileCliBase):
    """Translate English subtitles from Chinese subtitles."""

    localizations = merge_localizations(
        LLM_LOCALIZATIONS,
        ENG_TRANSLATE_FROM_ZHO_LOCALIZATIONS,
    )
    """Localized help text keyed by locale and English source text."""
