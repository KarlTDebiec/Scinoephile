...
"""Functions for English proofreading test cases (v2)."""
...
def load_test_cases_from_json(
    ...
    **kwargs: Any,
    ...
    Arguments:
        ...
        test_case_cls: test case class to use for test cases
        kwargs: additional keyword arguments passed to test_case_cls.get_test_case_cls
    Returns:
        list of test cases
    """
    ...
    for test_case_data in raw_test_cases:
        test_case_cls = test_case_cls.get_test_case_cls_from_data(
