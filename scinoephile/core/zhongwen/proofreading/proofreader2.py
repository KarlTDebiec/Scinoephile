...
__all__ = ["ZhongwenProofreader2"]


class ZhongwenProofreader2:
    """Proofreads 中文 subtitles."""

    def __init__(
        self,
        test_cases: list[ZhongwenProofreadingTestCase2] | None = None,
        ...
        queryer_cls = Queryer2.get_queryer_cls(ZhongwenProofreadingPrompt2)
    ...
    def proofread(self, series: Series, stop_at_idx: int | None = None) -> Series:
        ...
        for block_idx, block in enumerate(series.blocks):
            ...
            # Query LLM
            test_case_cls = ZhongwenProofreadingTestCase2.get_test_case_cls(len(block))
