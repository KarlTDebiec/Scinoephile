...
YueTranscriptionPromptYueHant = TranscriptionPrompt(
    ...
    **YUE_HANT_PROMPT_FIELDS,
    base_system_prompt=dedent_and_compact("""
        ...
        插入或者幻覺而刪除，尤其係突然轉語言嘅英文等孤立片段。講者列唔係獨立嘅詞彙
        證據，唔可以替單一來源嘅具體文字背書。只有其他來源喺相鄰或者重疊欄提供同一發音
        或者同一語句嘅另一寫法，清楚顯示問題係對齊偏移而唔係孤立插入，先可以保留單一列
        顯示嘅形式。唔好因為孤立文字語法通順或者符合語境就收錄。
        ...
        唔可以包含輸入嘅全形空格、停頓或者講者標記，唔需要逐欄對齊或者補空格。
    ...
    speaker="shuoshuuren",
    speaker_desc="逐欄對齊嘅全形講者、未分類同停頓標記",
    answer_text="wenben",
